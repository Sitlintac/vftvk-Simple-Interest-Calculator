function compute()
{
    ...
    var resultstring = "If you deposit <span class=\"resultvar\">" + principal +"</span>,<br> at an interest rate of <span class=\"resultvar\">" + rate + "%</span>,<br> You will receive an amount of <span class=\"resultvar\">" + interest + "</span><br> In the year <span class=\"resultvar\">" + year + "</span>";
